...
const groupWorkTimesByDay = (workTimes: WorkTime[]) => {
...
export default function MeetingWorkTime({ startDate, endDate }: { startDate: Date, endDate: Date }) {
    ...
    <div>
      <div className="flex justify-between items-center mb-2">
        ...
        <span className="text-lg font-medium">
          合計: {Math.floor(calculateTotalWorkDuration(filteredWorkTimes) / 60)}時間 {calculateTotalWorkDuration(filteredWorkTimes) % 60}分
        </span>
      </div>
